   ...
   /* private lateinit var viewModel: ShopItemViewModel
    ...
    private fun parseIntent() {
       ...
       if (screenMode == MODE_EDIT) {
        ...
        // рефакторинг выше написаного кода
        if (screenMode == MODE_EDIT) {
    ...
    companion object {
        private const val EXTRA_SCREEN_MODE = "extra_mode"  // или приватим константы и зоздаем метод
        ...
        fun newIntentEditItem(context: Context, shopItemId: Int): Intent {
            ...
            intent.putExtra(EXTRA_SCREEN_MODE, EXTRA_SHOP_ITEM_ID)
            return intent
        }
    }
}